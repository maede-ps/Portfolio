  ...
  return (
    <div className="bg-primary/60 h-full">
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10 ">
        ...
        h-full container mx-auto">
         ...
         className="h1 mb-4">
          ...
          <motion.p className="max-w-sm xl:max-w-xl mx-auto xl:mx-0 mb-2 xl:mb-4" 
          variants={fadeIn('down',0.3)} initial="hidden" animate="show" exit={"hidden"}
         >
            Aliqua laboris aliqua cupidatat ut aliqua voluptate dolor veniam
            nisi consectetur eu consectetur. Elit nisi nisi non culpa proident
            voluptate aute voluptate exercitation anim labore dolore culpa
            culpa. Do consequat tempor elit incididunt pariatur.
          </motion.p>
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        <div className="bg-none xl:bg-explosion xl:bg-cover xl:bg-bright xl:bg-no-repeat w-full h-full absolute mix-blend-color-dodge translate-z-0"></div>
       <ParticlesContainer/>
